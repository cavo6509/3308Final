...
app.get('/home/pick_color', function(req, res) {
	...
	var color_options =  `select hex_value from favorite_colors;`;// Write a SQL query to retrieve the colors from the database
...
app.get('/player_info', function(req, res) {
    ...
    .catch(err => {
        // display error message in case an error
            console.log('error', err);
            res.render('player_info/page_name',{
			    my_title: "Page Title Here",
                r1: '',
                r2: '',
                r3: '',
...
app.get('/player_info/post', function(req, res) {
    ...
    var q3 = `select count(*) from football_games where '${id}' = any(players)`;
